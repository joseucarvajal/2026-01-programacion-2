...
Que incluye:
    - En esta versión se pueden comprar N (muchos - varios) productos
    - Solución a los bugs 10 y 11
...
#El ciclo for-range se utiliza cuando se sabe cuantas veces se va a repetir
